...
const Footer = () => {
    return (
        <div>
            <footer aria-label="Site Footer" className="bg-white rounded-md">
  <div
  ...
  >
    ...
    >
      ...
      <div>
        <p className="font-medium text-gray-900">Contact Informations</p>

        <nav aria-label="Footer Navigation - Company" className="mt-6">
          <ul className="space-y-4 text-sm">
            <li>
              <p className="text-gray-700 transition hover:opacity-75">
                Contact No 1: +0081980394211
              </p>
            </li>

            <li>
              <p className="text-gray-700 transition hover:opacity-75">
              Contact No 2: +0081980324242
              </p>
            </li>

            <li>
              <p className="text-gray-700 transition hover:opacity-75">
                Business email: autoBotsBD_ph_hero@gmail.com
              </p>
            </li>
          </ul>
        </nav>
    ...
    <p className="text-xs text-gray-500 text-center">
      &copy; 2023. autobots. All rights reserved.
    </p>
  </div>
</footer>
        </div>
