  ...
  return (
    <div className="m-5 md:max-w-5xl md:mx-auto">
      <div href="#" className="relative block overflow-hidden rounded-lg border border-gray-100 p-4 sm:p-6 lg:p-8">
        ...
        <div>
          <h3 className="text-lg text-center mb-5 font-bold text-gray-900 sm:text-xl">Decepticons 1</h3>
        </div>
        ...
        <div className="flex items-center justify-evenly">
          <div className="sm:block sm:shrink-0">
            <img
              alt="Paul Clapton"
              src="https://i.ibb.co/jgj9S79/71-Pq-RNk-Cv-L-AC-UL400.jpg" 
          ...
          <div className="mb-5">
            <dl className="mt-6 flex gap-4 sm:gap-6">
              <div className="flex flex-col-reverse">
                <dt className="text-sm font-medium text-gray-600">3.2</dt>
